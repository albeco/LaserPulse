function p = lorentzianPulse(varargin)
%LORENTZIANPULSE creates a Lorentzian LaserPulse object in time domain
%
...
% p: LaserPulse object
%
% see also LaserPulse, gaussianPulse, sechPulse
