function p = gaussianPulse(varargin)
%GAUSSIANPULSE creates a Gaussian LaserPulse object in time domain
%
...
% p: LaserPulse object
%
% see also LaserPulse, lorentzianPulse, sechPulse
