...
% version log:
% 2015/06/18: changed behaviour for multidimensional arrays, now using the
%   center of mass of averaged pulses
% 2015/07/20: changed name from 'unwrapPulse' because old name was
%   misleading
